                ...
                <!-- 여기에 본문 내용 삽입 -->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            현재위치 :&nbsp; <a href="adm_main.do"><li class="breadcrumb-item">관리자</li></a> >&nbsp;관리 >&nbsp;<a href="adm_item_all.do"><li class="breadcrumb-item active">상품</li></a> >&nbsp;<a href="adm_item_complain.do"><li class="breadcrumb-item active">신고상품</li></a>
                        </ol>              
						...
						<!-- 상품 조회 테이블 -->
         				<%@ include file="../include/item/adm_item_complain_main.jsp" %> <!-- 메인 -->
