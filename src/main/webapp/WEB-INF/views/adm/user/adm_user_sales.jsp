                ...
                <!-- 여기에 본문 내용 삽입 -->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            현재위치 :&nbsp; <a href="adm_main.do"><li class="breadcrumb-item">관리자</li></a> >&nbsp;관리 >&nbsp;<a href="adm_user_alluser.do"><li class="breadcrumb-item active">회원</li></a> >&nbsp;<a href="adm_user_sales.do"><li class="breadcrumb-item active">판매자</li></a>
                        </ol>              
               
               		 	<%@ include file="../include/user_sub_menu.jsp" %> <!-- 서브 메뉴 -->
           						
						<!-- 판매자 조회 테이블 -->
         				<%@ include file="../include/user/adm_user_sales_main.jsp" %> <!-- 메인 -->
