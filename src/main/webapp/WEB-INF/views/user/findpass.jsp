...
<!-- Custom CSS -->
<link rel="stylesheet" href="../resources/style/findpass.css"
	type="text/css">
						...
						<div class="col-md-6 mb-3 d-flex align-items-center style="">
							<div class="flex-grow-1">
								<label for="useremail" style="width: 210px;">&nbsp;</label> <input
									...
									placeholder="이메일을 입력하세요" value="ksuwyg91@nate.com" required>
							...
							<div>
								...
								<button type="button" id="sendPhoneVerificationBtn"
									...
									background-color: #005555; color: white; border: none; 
									cursor: pointer;"
									onclick="sendEmail()">
									인증번호요청</button>
							</div>
						...
						<div class="col-md-6 mb-3 d-flex align-items-center">
							<div class="flex-grow-1">
								<label for="numcheck" style="width: 210px;">&nbsp;</label> <input
									...
									placeholder="인증번호6자리" value="" required
									maxlength="6"
									oninput="validateCheck2()"
									 pattern="^[0-9]{1,6}$"  style="border: 1px solid #ced4da;">
								<div class="invalid-feedback"></div>
							</div>
							<div>
