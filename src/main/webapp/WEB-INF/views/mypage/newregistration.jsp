                        ...
                        <div class="col-md-6">
                            <form>
                              <div class="mb-3">
								    ...
								    <input type="text" class="form-control" id="productName" value="${estate.est_id}" >
								</div>
                                <div class="mb-3">
                                    <label for="category" class="form-label">중개인번호</label>
                                    <input type="text" class="form-control" id="category" value="${estate.agent_num}" >
                                </div>
                                <div class="mb-3">
                                    <label for="registrationDate" class="form-label">등록일</label>
                                    <input type="text" class="form-control" id="registrationDate" value="${estate.est_reg_date}" >
                                </div>
                                 <div class="mb-3">
                                    <label for="registrationDate" class="form-label">거래완료일</label>
                                    <input type="text" class="form-control" id="traDate" value="${estate.est_tra_com_date}" >
                                </div>
                                <div class="mb-3">
                                    <label for="type" class="form-label">부동산 유형</label>
                                    <input type="text" class="form-control" id="type"  value="${estate.est_type}" >
                                </div>
                                <div class="mb-3">
                                    <label for="dealType" class="form-label">거래 유형</label>
                                    <input type="text" class="form-control" id="dealType" value="${estate.est_tra_type}" >
                                </div>
          						 <div class="mb-3">
                                    <label for="dealType" class="form-label">용도</label>
                                    <input type="text" class="form-control" id="dealType" value="${estate.est_usage}" >
                                </div>
      
                                <div class="mb-3">
                                    <label for="office" class="form-label">관리비</label>
                                    <input type="text" class="form-control" id="office"  value="${estate.est_manage}" >
                                </div>
                                <div class="mb-3">
                                    <label for="realEstateInfo" class="form-label">주소</label>
                                    <input type="text" class="form-control" id="office"  value="${estate.est_addr}" >
                                </div>
                            ...
                            <form>
			                    <div class="mb-3">
								    ...
								    <input type="text" class="form-control" id="option" 
								           value="<c:forEach var='option' items='${estOptionlist}'> ${option.est_opt_name} <c:if test='${!empty option.est_opt_name}'> </c:if> </c:forEach>" >
								</div>

                                <div class="mb-3">
                                    <label for="discountPrice" class="form-label">방수</label>
                                    <input type="text" class="form-control" id="discountPrice" value="${estate.est_room_num}" >
                                </div>
                                <div class="mb-3">
                                    <label for="realPrice" class="form-label">욕실수</label>
                                    <input type="text" class="form-control" id="realPrice" value="${estate.est_bath_num}" >
                                </div>
                            </form>
                        </div>
                    </div>
